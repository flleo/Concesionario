 ...
 * @author l
 */
@WebServlet(name = "ListControllerServlet", urlPatterns = {"/listController"})
public class ListControllerServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        List<Modelo> lista = DbManager.lista();
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
          ...
          try {
            ...
            Logger.getLogger(ListControllerServlet.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
